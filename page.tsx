      ...
      <div className="mt-12 rounded-2xl border border-white/10 bg-white/5 p-8">
        ...
        <div className="mt-6 space-y-4 text-sm text-gray-300">
          <div>
            ...
            — Structured, high-yield questions covering every ARRT category.
          </div>
          ...
          <div>
            ...
            — Questions must be answered correctly 3 times before leaving your deck.
          </div>
          ...
          <div>
            ...
            — Automatically created from missed questions so each review session raises your next score.
          </div>
      ...
      <div className="mt-16">
        ...
        <div className="mt-8 grid gap-6 md:grid-cols-3">
          ...
          <div className="relative rounded-2xl border border-blue-400 bg-white/5 p-6 text-center">
            ...
            <p className="mt-3 text-xs text-gray-400">Ideal for focused exam prep.</p>
            <button className="mt-6 w-full rounded-xl bg-yellow-400 py-2 text-sm font-semibold text-black hover:bg-yellow-300">
              Get 3 Months Access
            </button>
          </div>
          ...
          <div className="rounded-2xl border border-teal-400 bg-white/5 p-6 text-center">
            ...
            <div className="text-sm text-teal-400">$19 / month billed upfront</div>
