    ...
    <details className="mt-4 rounded-2xl rtt-card p-6">
      <summary className="cursor-pointer list-none">
        <div className="flex items-center justify-between">
          <div className="text-sm font-semibold">The Rad Tech Tutor Method That Works</div>
      ...
      <div className="mt-5 space-y-4 text-sm text-white/80">
        <div className="flex gap-3">
          ...
          <div>
            <div className="font-semibold text-white">Take a full mock (Exam Mode)</div>
          </div>
        </div>
        ...
        <div className="flex gap-3">
          ...
          <div>
            <div className="font-semibold text-white">
              Missed questions go into your Missed Question Flashcard Bank + Practice Test Bank
            </div>
          </div>
        </div>
        ...
        <div className="pt-2 text-xs text-white/60">
          Mastering QBank 1 is a strong indicator you’ll do well. For maximum confidence, increase your exposure by mastering
          additional QBanks.
        </div>
      </div>
    </details>
